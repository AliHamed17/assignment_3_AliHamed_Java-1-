...
public class SongLibrary {
    ...
    private Song littleJonathan()  throws  SoundException
    {
        int quarter = 250;
        int half = 2 * quarter;
    ...
    private Song iFeelTheEarthMove()  throws  SoundException
    {
        int eighth = 256;
    ...
    private Song hissingOfSummerLawns() throws  SoundException
    {
        int eighth = 180;
    ...
    private Song trill()  throws  SoundException
    {
